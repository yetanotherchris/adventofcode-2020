...
times a given letter must appear for the password to be valid. For example, 
...
is not; it contains no instances of b, but needs at least 1. The first and third 
